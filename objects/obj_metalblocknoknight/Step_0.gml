...
{
    if ((place_meeting((x + 1), y, obj_player) || place_meeting((x - 1), y, obj_player)) && (obj_player.state == 83 || obj_player.state == 11 || obj_player.state == 2 || obj_player.state == 30 || (obj_player.state == 17 && obj_player.momemtum == 1)))
        instance_destroy()
