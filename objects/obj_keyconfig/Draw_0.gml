...
draw_text(580, 50, key_to_string(global.key_up))
if (key_select == 1)
...
draw_text(580, 100, key_to_string(global.key_down))
if (key_select == 2)
...
draw_text(580, 150, key_to_string(global.key_right))
if (key_select == 3)
...
draw_text(580, 200, key_to_string(global.key_left))
if (key_select == 4)
...
draw_text(580, 250, key_to_string(global.key_jump))
if (key_select == 5)
...
draw_text(580, 300, key_to_string(global.key_slap))
if (key_select == 6)
...
draw_text(580, 350, key_to_string(global.key_attack))
if (key_select == 7)
...
draw_text(580, 400, key_to_string(global.key_taunt))
if (key_select == 8)
...
draw_text(580, 450, key_to_string(global.key_start))
if (key_select == 9)
    draw_text_colour(420, 500, "SHOOT", c_white, c_white, c_white, c_white, 1)
else
    draw_text_colour(420, 500, "SHOOT", c_white, c_white, c_white, c_white, 0.5)
draw_text(580, 500, key_to_string(global.key_shoot))