	...
	with (obj_player)
	{
	    switch character {
			case "P":
				...
				spr_Sjumpprep = spr_player_superjumppreplight
				spr_Sjumpstart = spr_player_superjumpprep
			...
			case "N":
				...
				spr_machfreefall = spr_playerN_machfreefall
				spr_machroll = spr_playerN_machroll
				spr_Sjumpprep = spr_playerN_Sjumpprep
				spr_Sjumpstart = spr_playerN_Sjumpstart
